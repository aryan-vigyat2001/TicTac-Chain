...
export interface HelloWormholeProtectionsTestInterface extends utils.Interface {
  functions: {
    ...
    "setActiveForks((uint16,string,string,address,address,address)[])": FunctionFragment;
    "setMainnetForkChains(uint16,uint16)": FunctionFragment;
    "setTestnetForkChains(uint16,uint16)": FunctionFragment;
    "setUp()": FunctionFragment;
    "setUpFork((uint16,string,string,uint256,address,address,address,address))": FunctionFragment;
    "setUpGeneral()": FunctionFragment;
    "setUpOther((uint16,string,string,uint256,address,address,address,address))": FunctionFragment;
...
export interface HelloWormholeProtectionsTest extends BaseContract {
  ...
  functions: {
    ...
    activeForks(
      ...
      [number, string, string, BigNumber, string, string, string, string] & {
        chainId: number;
        name: string;
        url: string;
        fork: BigNumber;
